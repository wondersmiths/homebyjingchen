...
.ast-mobile-popup-drawer,.ast-mobile-popup-drawer.active,.ast-mobile-popup-drawer .ast-mobile-popup-inner,.ast-mobile-popup-drawer.active .ast-mobile-popup-inner,.ast-mobile-popup-content{background:#1B2A4A!important;background-color:#1B2A4A!important}
.ast-mobile-header-content,.ast-mobile-header-wrap,.ast-mobile-header-wrap .ast-mobile-header-content,.ast-main-header-wrap .ast-mobile-menu-buttons{background:#1B2A4A!important;background-color:#1B2A4A!important}
.ast-mobile-popup-content .menu-item>a,.ast-mobile-popup-content .ast-menu-toggle,.ast-builder-menu-mobile .menu-item>a{color:#fff!important}
.ast-mobile-popup-content .menu-item>a:hover,.ast-mobile-popup-content .menu-item>a:focus{color:#C9A84C!important}
.ast-mobile-popup-content .sub-menu,.ast-mobile-popup-content ul.sub-menu,.ast-builder-menu-mobile .sub-menu{background:#152238!important;background-color:#152238!important}
.ast-mobile-popup-content .sub-menu .menu-item>a,.ast-builder-menu-mobile .sub-menu .menu-item>a{color:rgba(255,255,255,.8)!important;padding-left:24px!important}
...
.ast-header-break-point .main-header-bar,.ast-header-break-point .ast-mobile-header-wrap{background:#1B2A4A!important;background-color:#1B2A4A!important}
.ast-header-break-point .main-navigation,.ast-header-break-point .main-navigation ul,.ast-header-break-point .main-navigation ul.sub-menu{background:#1B2A4A!important;background-color:#1B2A4A!important}
...
.ast-header-break-point .ast-above-header-menu,.ast-header-break-point .ast-below-header-menu,.ast-flyout-above,.ast-flyout-below{background:#1B2A4A!important}
#ast-mobile-header,#ast-mobile-header .menu-item>a{color:#fff!important}
.ast-mobile-popup-drawer .close,.ast-mobile-popup-close,.ast-mobile-popup-drawer button.close,.ast-mobile-popup-content .ast-mobile-popup-close{color:#fff!important;fill:#fff!important}
.ast-mobile-popup-overlay{background:rgba(0,0,0,.6)!important}
[data-section="popup"] .ast-builder-layout-element{background:#1B2A4A!important;background-color:#1B2A4A!important}
